            ...
            <div class="box">
                ...
                <div class="box-body">
                    <form method="post" id="saveForm">
                        ...
                        <div class="form-group">
                            <label>资源URL</label>
                            <input type="text" name="permissionUrl" class="form-control" value="${permission.permissionUrl}">
                        </div>
                        <div class="form-group">
                            <label>权限类型</label>
                        ...
                        <div class="form-group">
                            ...
                            <select name="parentId" class="form-control">
                                ...
                                <c:forEach items="${premissionList}" var="permission">
