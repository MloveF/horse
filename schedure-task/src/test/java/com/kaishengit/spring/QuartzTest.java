...
public class QuartzTest {
    ...
    public void addJob() throws SchedulerException, IOException {
        ...
        dataMap.put("weixin","zhangsan");


        JobDetail jobDetail = JobBuilder.newJob(SendWeixin.class)
                //!定义任务的唯一性（名称+组名）
                .withIdentity("weixin:zhangsan","sendWeixin")
                .setJobData(dataMap)
                .build();

        String cron = "0 22 21 7 5 ? 2018";
    ...
    public void deleteTask() throws SchedulerException {
        Scheduler scheduler = schedulerFactoryBean.getScheduler();
        scheduler.deleteJob(new JobKey("weixin:zhangsan","sendWeixin"));
    }
